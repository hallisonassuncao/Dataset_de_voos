...
Etapas da Análise
Carregamento e inspeção dos dados (shape, head, tail, info)
Tratamento de valores ausentes: preenchimento de dep_delay e arr_delay (10% de nulos cada) com a mediana
Limpeza de colunas categóricas: remoção de espaços em branco
Conversão de tipos: fl_date convertida para datetime
